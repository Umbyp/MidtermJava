...
//        return ResponseEntity.ok("Upload Folder (Directory) is \""  //return ResponseEntity.ok(fileStorageProperties) ได้เป็น json ออกไป
//                + fileStorageProperties.getUploadDir()+ "\"........."
//                +fileStorageProperties.getFileServiceHostName()+"\"");
    }
    ...
    public ResponseEntity<Resource> serveFile(@PathVariable String filename) {
        ...
        switch (extension) {
            ...
            default:
                return ResponseEntity.ok().contentType(MediaType.ALL).body(file);//ถ้ามี return ไม่ต้องมี break; เพราะมันจบตรง return
        }
    ...
    public ResponseEntity<Object> removeFile(@PathVariable String filename) {
        ...
        return ResponseEntity.ok(filename+"File remove success !!!!!!!!");
    }
