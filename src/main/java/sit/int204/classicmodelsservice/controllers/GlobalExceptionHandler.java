...
"Validation error. Check 'errors' field for details.", request.getDescription(false));
    ...
    public ResponseEntity<ErrorResponse> handleItemNotFoundException(
            RuntimeException exception, WebRequest request) {//อาจจะใช้ super class
    ...
    public ResponseEntity<ErrorResponse> handleAllUncaughtException( //ถ้าไม่ใช่ not found เข้าอันนี้หมด response exception
