...
public class ProductController {
    ...
    public ResponseEntity<Object> findAllProducts(
            ...
            @RequestParam(defaultValue = "10") @Max(20) int pageSize)

            {

//        String responseString = "lower:" +lower+ "\nupper:"+upper+
//                "\npart-of-product-name: '"+partOfProductName+"'";
    ...
    @GetMapping("/product-line/{id}")
     public ResponseEntity<Object> getProductByCategory(@PathVariable String id){
...
//        er.addValidationError("field #1 ","Error message #1"); // ตัวอย่างไม่ควรทำ แค่123
